...
class WebserviceController extends Controller
{
    ...
    public function stepOneCSV(Request $request)
    {
        $result = $this->getCursosCSV($request);
        return response($result, 200);
    }

    public function getCursosCSV(Request $request)
    {

        $newDataAdded = (new WebserviceService)->getCursosCSV($request);

        return $newDataAdded;
    }

    public function stepTwoCSV(Request $request)
    {
        $result = $this->getInscricoesturnosCSV($request);
        return response($result, 200);
    }
    ...
    public function getInscricoesturnosCSV($request)
    {
        ...
        $data = (new WebserviceService)->getInscricoesturnosCSV($request);
        return $data;
    }

    public function stepFourCSV(Request $request)
    {
        $result = (new WebserviceService)->getAulasCSV($request);
        return response($result, 200);
    }
