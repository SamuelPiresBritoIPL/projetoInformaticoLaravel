...
Route::group(['middleware' => ['auth:api', 'admin'], 'prefix' => 'webservice'], function () {
    ...
    Route::post('stepOneCSV', [WebserviceController::class, 'stepOneCSV']);
    Route::post('stepTwoCSV', [WebserviceController::class, 'stepTwoCSV']);
    Route::post('stepFourCSV', [WebserviceController::class, 'stepFourCSV']);
